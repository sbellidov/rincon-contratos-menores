...
| **Calidad de datos** | Anomalías detectadas: CIFs inválidos, fechas erróneas, importes anómalos |
...
- **Frontend**: HTML + CSS + JavaScript (vanilla) + Chart.js + Lucide icons · tipografía Inter · tema oscuro
...
Los Excel del ayuntamiento contienen errores frecuentes: CIFs inválidos o ausentes, fechas mal formateadas, el mismo contratista con grafías distintas, áreas con nombres inconsistentes entre trimestres, etc.

El ETL aplica correcciones automáticas:

- **Propagación de CIFs**: si un nombre aparece sin CIF en un registro pero con CIF válido en otro, se completa automáticamente.
- **Nombre canónico**: se elige por moda estadística por CIF, para unificar variantes del mismo contratista.
- **Normalización de áreas**: más de 100 variantes textuales se mapean a 31 áreas canónicas.
- **Validación de NIFs/CIFs**: algoritmo oficial de la Agencia Tributaria (módulo 23 para NIF/NIE, suma ponderada para CIF).
